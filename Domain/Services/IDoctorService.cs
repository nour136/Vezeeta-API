...
namespace Domain.Services
{
    public interface IDoctorService
    {
        ...
        Task<ResponseModel<string>> ConfirmBookingAsync(string doctorId, int bookingId);
        Task<ResponseModel<string>> CompleteBookingAsync(string doctorId, int bookingId);
        Task<ResponseModel<string>> CancelBookingAsync(string doctorId, int bookingId);
